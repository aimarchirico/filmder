drop policy "genres allow all" on "public"."genres";

drop policy "movie_genres allow all" on "public"."movie_genres";

drop policy "movies allow all" on "public"."movies";
...
alter table "public"."movies" alter column "rating" set not null;
